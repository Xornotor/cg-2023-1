...
function geraTerreno() {
    ...
    const terreno	= new THREE.Mesh 	(	new THREE.PlaneGeometry( 100, 100, 500, 500 ), 
    										shaderMat
										); 
...
function initGUI() {
	...
	gui.add( controls, 'EscalaTanh', 0, 5).onChange(mudaEscalaTanh);
...
function mudaEscalaTanh() {

	var obj = scene.getObjectByName("terreno");
	obj.material.uniforms.uEscalaTanh.value = controls.EscalaTanh;
	obj.material.uniformsNeedUpdate = true;
};
